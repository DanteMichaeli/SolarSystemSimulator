...
val dt: Double = 60*60*24 //larger time-step means faster simulation, but less accurate


//GUI CONSTANTS
val GUIwidth: Int = 1400
val GUIheight: Int = 1400
val scalingFactor = 2000000000   // 1 pixel = 2 billion meters
